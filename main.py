...
num_classes = 535
cnn_model = cnn.ConvNet(img_size, num_classes, model_num = 3) # create a 3D-CNN
cnn_model.summary() # print summary
cnn_model.train(train_paths, test_paths, exp_name = 'Exp3') # trains model with epochs = 50, batch_size = 16
