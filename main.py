...
num_classes = 133
'''for i in range(5, 7):
    crnn_model = crnn.CRNN(img_size, num_classes, model_num = i) # create a CRNN
    crnn_model.summary() # print summary
    crnn_model.train(train_paths, test_paths, exp_name = "Exp" + str(i)) # trains model with epochs = 50, batch_size = 16
'''
utils.vary_adamLR(train_paths, test_paths)
